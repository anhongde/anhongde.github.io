window.skins={};
	...
	function GameSceneSkin() {
		_super.call(this);
		this.skinParts = ["dr0","dr1","dr2","dr3","dr4","dr5","windRoot","title1_img","swBtn","goBackBtn","completeBtn","titleRoot","goBackBtn3","name_text","time_text","completeBtn3","shareRoot","backBtn0","backBtn1","backBtn2","backBtn3","backBtn4","backBtn5","backBtn6","backBtn7","backBtn8","backBtn9","select_img","selectRoot","downRoot","title2_img","logo_img","leftBtn","leftBtn0","upRoot"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this.downRoot_i(),this.upRoot_i()];
	}
	...
	_proto.windRoot_i = function () {
		...
		t.x = 65;
		t.y = 97;
		t.elementsContent = [this._Image2_i(),this._Image3_i(),this.dr0_i(),this.dr1_i(),this.dr2_i(),this.dr3_i(),this.dr4_i(),this.dr5_i(),this._Image4_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.titleRoot_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image5_i(),this.title1_img_i(),this.swBtn_i(),this.goBackBtn_i(),this.completeBtn_i()];
		return t;
	};
	...
	_proto.shareRoot_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.goBackBtn3_i(),this._Image6_i(),this.name_text_i(),this.time_text_i(),this.completeBtn3_i()];
		return t;
	};
	...
	_proto.selectRoot_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image7_i(),this.backBtn0_i(),this.backBtn1_i(),this.backBtn2_i(),this.backBtn3_i(),this.backBtn4_i(),this.backBtn5_i(),this.backBtn6_i(),this.backBtn7_i(),this.backBtn8_i(),this.backBtn9_i(),this.select_img_i()];
		return t;
	};
